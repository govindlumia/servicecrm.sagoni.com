...
public partial class Inventory_Inventory_Product : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            if (Request.QueryString["serial_no"] != null)
            {
                ...
                objReader = pm.Inventory_Product_Update(Request.QueryString["serial_no"].ToString());
    ...
    protected void ImageButton1_Click(object sender, ImageClickEventArgs e)
    {
        ...
        {
            objReader = pm.CheckExistingInventory(Txt_ProductCode.Text);
            if (objReader.Read())
            {
                lblmsg.Visible = true;
            ...
            pm.flag = "I";
            pm.sno = "0";
            value = pm.Inventory_Product_Insert(pm);
        }
        ...
        Response.Redirect("~/Inventory/Inventory_Product_View.aspx");
    }
