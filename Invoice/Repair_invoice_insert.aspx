<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Repair_invoice_insert.aspx.cs" Inherits="Invoice_Repair_invoice_insert" Culture ="en-GB" UICulture ="en-GB"%>
...
<tr>
<td class="dvtTabCache create" style="width:65%" nowrap><span class="lvtHeaderText"> Create Repair Invoice</span></td>
</table>
</td>
 </tr>
<tr>
 ...
 Width="148px" Font-Bold="True" CausesValidation="False" onclick="btn_calllog_Click"  />
             ...
             <asp:Button ID="Button2" runat =server Text ="Cancel"  CausesValidation=false />
                                              ...
                                              <%--  &nbsp;<asp:CheckBox ID="chkRenewal" runat="server"  
                                                ...
                                                id="Image1" style="Z-INDEX: 101; LEFT: 524px; VISIBILITY:hidden ;  
...
POSITION: absolute; TOP: 240px; width: 60px;"/>
								   ...
								   <%--<tr>  <asp:Label ID="lblMsg" runat =server Visible =false ForeColor =Red ></asp:Label>
									<td  colspan=4 style="padding: 2px 5px 5px;">
									   <div align="center">
...
<td align="left" class="dvtCellInfo" style="width: 20%">
 <asp:TextBox ID="Txt_Amountpaid" CssClass="textbox" runat="server"  Height="22px" 
        ...
        ontextchanged="Txt_Amountpaid_TextChanged"  ></asp:TextBox>
</td>
			...
			<td align=left class="dvtCellInfo" style="width: 21%">
                           ...
                           <td class="dvtCellLabel" align="right" style="width: 6%">
                                                                VAT</td>
                                                                        ...
                                                                        <td class="tax_border">
                                                                            <asp:TextBox ID="txttaxAmount" class="tax_margin_left textbox" Text="4.00" runat="server" />
                                                                        </td>
