<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PrintRepairInvoice.aspx.cs" Inherits="PrintRepairInvoice" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
 <title> REPAIR INVOICE DETAILS </title>
...
--%>    </td>
    ...
    <b style="padding-left:225px">REPAIRE&nbsp; INVOICE</b>
    </td>
    </tr>
    ...
    <td style="border:1px solid #8C8C8C; text-align:center; width:200px"><b>Product Description</b></td> 
    <td style="border:1px solid #8C8C8C; text-align:center; width:200px"><b>No Of Device</b></td>
    <td style="border:1px solid #8C8C8C; text-align:center; width:400px"><b>Remarks</b></td> 
   ...
   <%-- <tr>
	...
	<strong>GADGETGOLD E-SERVICE</strong>
    </p>
