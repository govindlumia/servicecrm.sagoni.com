<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Refund_Service_Invoice.aspx.cs" Inherits="Refund_Refund_Service_Invoice" %>
				...
				<table border=0 cellspacing=0 cellpadding=3 width=100% class="small">
				   <tr>
                   				...
                   				<td class="dvtTabCache create" nowrap><span class="lvtHeaderText">
                                    Refund Service Invoice</span></td>
									   </table>
			</td>
...
<!-- Added this file to display the fields in Create Entity page based on ui types  -->
 ...
 <tr style="height: 25px">
 <td class="dvtCellLabel" align="right" style="width: 6%"> Total Amount</td>
<td align="left" class="dvtCellInfo" style="width: 20%">
 <asp:TextBox ID="txtunit" CssClass="textbox" runat="server"  Height="22px" Width="128px"></asp:TextBox>
</td>
<td class="dvtCellLabel" align="right" style="width: 6%">Refund Amount
</td>
