<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="my_dashboard.aspx.cs" Inherits="Sales_my_dashboard" Culture="en-GB" UICulture="en-GB"%>
...
<label style=" font-family:Arial; font-style:normal; font-weight:bold; color:Black ; font-size:22px;padding-left:15px">MY DashBoard </label>
  
</td>
</tr>
 <tr>
 <td  style=" padding-bottom:0px; padding-left:380px; width:1118px; color:Black"><b> Daily Transction&nbsp; </b>
