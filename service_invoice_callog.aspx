<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="service_invoice_callog.aspx.cs" Inherits="service_invoice_callog" %>
...
Service Invoice Call Logs </label>
 ...
 <%#Container.DataItemIndex+1 %>
           ...
           <asp:BoundField DataField="serial_no" Visible="false" HeaderText="Serial_No" />  
              <asp:BoundField DataField="lead_no" HeaderText="Lead No" /> 
               <asp:BoundField DataField="service_charge" HeaderText="Service Charge" />
